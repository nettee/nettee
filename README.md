...
|---------|-------------|-------|
| [nexu-io/open-design](https://github.com/nexu-io/open-design) | Local-first, open-source alternative to Claude Design — design skills, brand-grade systems, sandboxed preview and HTML/PDF/PPTX export | ⭐ 89.8k |
...
| Project | Description | Stars |
|---------|-------------|-------|
| [gemini-cli-proxy](https://github.com/nettee/gemini-cli-proxy) | Wrap Gemini CLI as an OpenAI-compatible API — free Gemini Pro via API | ⭐ 151 |
